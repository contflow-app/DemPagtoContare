...
def _gpt_extract(page_text: str, model: str) -> Dict:
    ...
    system = (
        "Você extrai dados de holerites/recibos brasileiros. "
        "Se não houver certeza, retorne null. Não invente."
    )
    user = (
        ...
        "  \"cpf\": string|null,\n"
        "  \"liquido\": number|null,\n"
        "  \"verba_8781\": number|null,\n"
        "  \"verba_981\": number|null,\n"
        "  \"evidencia_nome\": string|null,\n"
        "  \"evidencia_cpf\": string|null\n"
        "}\n\n"
        "Regras:\n"
        "- CPF deve estar no formato 000.000.000-00.\n"
        "- Use exatamente o nome do colaborador (sem incluir matrícula/códigos).\n"
        "- Se houver múltiplos CPFs, escolha o do colaborador (não da empresa).\n"
        "- Se não tiver evidência textual clara, use null.\n\n"
        "TEXTO DA PÁGINA:\n"
        f"{page_text}"
    )
