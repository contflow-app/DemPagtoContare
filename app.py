...
if st.button("Processar", type="primary"):
    ...
    for c in colabs:
        ...
        v8781 = c.get("verba_8781")
        v981 = c.get("verba_981")
        pagamentos_anteriores = c.get("pagamentos_anteriores")
        ...
        if bruto_ref is not None and liquido is not None:
            ...
            aplica_especial = (liquido_num <= limiar and status_colab.upper().startswith("ATIV"))

            if aplica_especial:
                regra = "ESPECIAL (liq~0 & ATIVO): bruto_ref - 8781 - 981 - pagamentos_anteriores"
